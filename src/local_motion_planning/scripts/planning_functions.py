...
def compute_polytope(obstacles, start, bounds, require_containment=False, required_containment_pts=[]):
    region, debug = irispy.inflate_region(obstacles, start, bounds=bounds, require_containment=require_containment, required_containment_points=required_containment_pts, return_debug_data=True)
    A, b = None, None
    try:
